...
const CustomerServiceTop=()=>{
    return(<div className='Complainttop-conatiner'>
    <div>
        <img src="https://t4.ftcdn.net/jpg/01/37/42/39/360_F_137423986_zMrijnjNWRjz2aruPYRJLSnpZDSSphqe.jpg" alt="thumbsup-logo" className="thumbsup-logo-cf"/>
        <p className='complaintTop-para-1'>Customer service</p>
    </div>
