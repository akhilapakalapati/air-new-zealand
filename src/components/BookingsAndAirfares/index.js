...
const BookingsAndAirfaresTop=()=>{
    return(<div className='Complainttop-conatiner'>
    <div>
        <img src="https://t3.ftcdn.net/jpg/02/30/04/20/360_F_230042044_T0UEPDX13ZL4kvfCrM20p2fPwknxUTvo.jpg" alt="thumbsup-logo" className="thumbsup-logo-cf"/>
        <p className='complaintTop-para-1'>Bookings and airfares</p>
    </div>
...
export default BookingsAndAirfares;